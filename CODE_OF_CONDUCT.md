...
requests, discussions) related to this project, and also applies when an
...
GitHub (or, if you'd prefer not to use a public issue tracker, by contacting
a maintainer directly through their GitHub profile). All complaints will be
reviewed and investigated promptly and fairly.

<!-- TODO: replace with a dedicated reporting email/contact once one is
     designated, e.g. conduct@<project-domain> -->
