...
import {
	MULTIPLE_KEYS_MUST_BE_ARRAY,
	MULTIPLE_KEYS_MUST_BE_HAVE_KEYS,
} from "./errors.mjs";
...
describe("getValuesForMultipleKeys", () => {
	...
	it("should throw error when manyKeys is not an array", () => {
		assert.throws(() => getValuesForMultipleKeys("not-an-array", {}, mockDB), {
			message: MULTIPLE_KEYS_MUST_BE_ARRAY,
		});

		assert.throws(() => getValuesForMultipleKeys(null, {}, mockDB), {
			message: MULTIPLE_KEYS_MUST_BE_ARRAY,
		});

		assert.throws(() => getValuesForMultipleKeys(undefined, {}, mockDB), {
			message: MULTIPLE_KEYS_MUST_BE_ARRAY,
		});

		assert.throws(() => getValuesForMultipleKeys(123, {}, mockDB), {
			message: MULTIPLE_KEYS_MUST_BE_ARRAY,
		});
	});

	it("should throw for empty array as input", () => {
		assert.throws(() => getValuesForMultipleKeys([], {}, mockDB), {
