...
export const MULTIPLE_KEYS_MUST_BE_ARRAY =
	"Invalid input: manyKeys must be an array";
export const MULTIPLE_KEYS_MUST_BE_HAVE_KEYS =
	"Invalid input: manyKeys must have at least one key";
// Selector error messages
export const KEY_SELECTOR_INVALID = "Invalid key selector";
export const KEY_SELECTOR_RANGE_START_OVER_END =
	"Start key is greater than end key";
export const KEY_SELECTOR_RANGE_START_NOT_IN_PREFIX =
	"Start key is not in the key space defined by prefix";
export const KEY_SELECTOR_RANGE_END_NOT_IN_PREFIX =
